...
TShutdownMode CKernel::Run (void)
{
	...
	{
		m_Logger.Write (FromKernel, LogNotice, "Partion was found: %s", PARTITION);
	}
	...
	{
		m_Logger.Write (FromKernel, LogNotice, "Partion was mounted: %s", PARTITION);
	}
...
/*
	...
	m_Screen.Write ("\n", 1);
*/
	m_Logger.Write (FromKernel, LogNotice, "No longer looking through root directory. Creating file now.");
